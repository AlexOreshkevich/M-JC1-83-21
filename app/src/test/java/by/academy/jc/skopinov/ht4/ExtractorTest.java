...
class ExtractorTest {
  ...
  @Test
  void input00Line1() {
    assertEquals("Nayeem loves counseling", Extractor.extractingContent("<h1>Nayeem loves counseling</h1>"));
  }

  @Test
  void input00Line2() {
    assertEquals("Sanjay has no watch", Extractor.extractingContent("<h1><h1>Sanjay has no watch</h1></h1><par>So wait for a while<par>"));
  }

  @Test
  void input00Line3() {
    assertEquals("None", Extractor.extractingContent("<Amee>safat codes like a ninja</amee>"));
  }

  @Test
  void input00Line4() {
    assertEquals("Imtiaz has a secret crash", Extractor.extractingContent("<SA premium>Imtiaz has a secret crash</SA premium>"));
  }

  @Test
  void input01Line1() {
    assertEquals("some", Extractor.extractingContent("<h1>some</h1>"));
  }

  @Test
  void input01Line2() {
    assertEquals("public", Extractor.extractingContent("<h1>had<h1>public</h1></h1>"));
  }

  @Test
  void input01Line3() {
    assertEquals("None", Extractor.extractingContent("<h1>had<h1>public</h1515></h1>"));
  }

  @Test
  void input01Line4() {
    assertEquals("None", Extractor.extractingContent("<h1><h1></h1></h1>"));
  }

  @Test
  void input01Line5() {
    assertEquals("None", Extractor.extractingContent("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"));
  }
  ...
  @Test
  void input01Line8() {
    assertEquals("None", Extractor.extractingContent("<>hello</>"));
  }

  @Test
  void input01Line9() {
    assertEquals("dim", Extractor.extractingContent("<>hello</><h>dim</h>"));
  }
  ...
  @Test
  void input02Line1() {
    assertEquals("bMUGux)5n7L={M}e^`0xlSm5ce}ehiE}CJ6y0KPd~~B~ak5$PTdPGv}QnXpw6n9V8wVCVaTRTgLKkeF", Extractor
  ...
  @Test
  void firstCheck2() {
    assertEquals("", Extractor.extractingContent("<mee>safat codes like a ninja</Amee>"));
  }

  @Test
  void firstCheck3() {
    assertEquals("", Extractor.extractingContent("<m>s</A>"));
  }
  ...
  @Test
  void secondCheck2() {
    assertEquals("None", Extractor.extractingContent("<H1>some</h1>"));
  }

  @Test
  void secondCheck3() {
    assertEquals("None", Extractor.extractingContent("<h1>some<h11>"));
  }
}
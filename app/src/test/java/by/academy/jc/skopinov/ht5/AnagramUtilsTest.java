...
class AnagramUtilsTest {
  ...
  void fiftyDifferentLetters() throws IllegalArgumentException {
    assertFalse(AnagramUtils.isAnagram("jklajefGJkgHFjHGjhkjGkjgkjggKJglkjhLJKgjhHJHjgLgdQ", "jKfghgFjGJHghjGfJHFHJJHGjjhgjhgjHGGhhlfDduLffHkFjk"));
  }
  ...
  void wrongInputFiftyOneLetters() {
    assertThrows(IllegalArgumentException.class, ()-> AnagramUtils.isAnagram("jklajefGJkgHFjHGjhkjGkjgkjggKJglkjhLJKgjhHJHjgLgdQw", "jKfghgFjGJHghjGfJHFHJJHGjjhgjhgjHGGhhlfDduLffHkFjkP"));
  }

  @Test
  void wrongInputInvalidCharacter() {
    assertThrows(IllegalArgumentException.class, ()-> AnagramUtils.isAnagram("hello_world", "hello_world"));
  }
}
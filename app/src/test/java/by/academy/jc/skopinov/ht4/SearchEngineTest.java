...
class SearchEngineTest {
  ...
  @Test
  void input00Line1() {
    assertEquals("Nayeem loves counseling", SearchEngine.extractingContent("<h1>Nayeem loves counseling</h1>"));
  }

  @Test
  void input00Line2() {
    assertEquals("Sanjay has no watch", SearchEngine.extractingContent("<h1><h1>Sanjay has no watch</h1></h1><par>So wait for a while<par>"));
  }

  @Test
  void input00Line3() {
    assertEquals("None", SearchEngine.extractingContent("<Amee>safat codes like a ninja</amee>"));
  }

  @Test
  void input00Line4() {
    assertEquals("Imtiaz has a secret crash", SearchEngine.extractingContent("<SA premium>Imtiaz has a secret crash</SA premium>"));
  }

  @Test
  void input01Line1() {
    assertEquals("some", SearchEngine.extractingContent("<h1>some</h1>"));
  }

  @Test
  void input01Line2() {
    assertEquals("public", SearchEngine.extractingContent("<h1>had<h1>public</h1></h1>"));
  }

  @Test
  void input01Line3() {
    assertEquals("None", SearchEngine.extractingContent("<h1>had<h1>public</h1515></h1>"));
  }

  @Test
  void input01Line4() {
    assertEquals("None", SearchEngine.extractingContent("<h1><h1></h1></h1>"));
  }

  @Test
  void input01Line5() {
    assertEquals("None", SearchEngine.extractingContent("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"));
  }
  ...
  @Test
  void input01Line8() {
    assertEquals("None", SearchEngine.extractingContent("<>hello</>"));
  }

  @Test
  void input01Line9() {
    assertEquals("dim", SearchEngine.extractingContent("<>hello</><h>dim</h>"));
  }
  ...
  @Test
  void input02Line1() {
    assertEquals("bMUGux)5n7L={M}e^`0xlSm5ce}ehiE}CJ6y0KPd~~B~ak5$PTdPGv}QnXpw6n9V8wVCVaTRTgLKkeF", SearchEngine
  ...
  @Test
  void firstCheck2() {
    assertEquals("", SearchEngine.extractingContent("<mee>safat codes like a ninja</Amee>"));
  }

  @Test
  void firstCheck3() {
    assertEquals("", SearchEngine.extractingContent("<m>s</A>"));
  }
  ...
  @Test
  void secondCheck2() {
    assertEquals("None", SearchEngine.extractingContent("<H1>some</h1>"));
  }

  @Test
  void secondCheck3() {
    assertEquals("None", SearchEngine.extractingContent("<h1>some<h11>"));
  }
}
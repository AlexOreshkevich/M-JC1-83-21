...
class Solution4Test {
  ...
  void firstCheck1() throws IllegalArgumentException {
    assertEquals("None", Solution4.firstCheck("<Amee>safat codes like a ninja<Amee>"));
  }

  @Test
  void firstCheck2() throws IllegalArgumentException {
    assertEquals("", Solution4.firstCheck("<mee>safat codes like a ninja</Amee>"));
  }

  @Test
  void firstCheck3() throws IllegalArgumentException {
    assertEquals("", Solution4.firstCheck("<m>s</A>"));
  }

  @Test
  void firstCheck4() throws IllegalArgumentException {
    assertEquals("", Solution4.firstCheck("<ABC>ghdfghs</ABC>"));
  }

  @Test
  void secondCheck1() throws IllegalArgumentException {
    assertEquals("some", Solution4.secondCheck("<h1>some</h1>"));
  }

  @Test
  void secondCheck2() throws IllegalArgumentException {
    assertEquals("None", Solution4.secondCheck("<H1>some</h1>"));
  }

  @Test
  void secondCheck3() throws IllegalArgumentException {
    assertNull(Solution4.secondCheck("<h1>some<h11>"));
  }

  @Test
  void secondCheck4() throws IllegalArgumentException {
    assertEquals("None", Solution4.secondCheck("<h1>some</h11>"));
  }
}
...
class Solution4Test {
  ...
  void input00Line1() throws IllegalArgumentException {
    assertEquals("Nayeem loves counseling", Solution4Util.extractingContent("<h1>Nayeem loves counseling</h1>"));
  }

  @Test
  void input00Line2() throws IllegalArgumentException {
    assertEquals("Sanjay has no watch", Solution4Util.extractingContent("<h1><h1>Sanjay has no watch</h1></h1><par>So wait for a while<par>"));
  }

  @Test
  void input00Line3() throws IllegalArgumentException {
    assertEquals("None", Solution4Util.extractingContent("<Amee>safat codes like a ninja</amee>"));
  }

  @Test
  void input00Line4() throws IllegalArgumentException {
    assertEquals("Imtiaz has a secret crash", Solution4Util.extractingContent("<SA premium>Imtiaz has a secret crash</SA premium>"));
  }

  @Test
  void input01Line1() throws IllegalArgumentException {
    assertEquals("some", Solution4Util.extractingContent("<h1>some</h1>"));
  }

  @Test
  void input01Line2() throws IllegalArgumentException {
    assertEquals("public", Solution4Util.extractingContent("<h1>had<h1>public</h1></h1>"));
  }

  @Test
  void input01Line3() throws IllegalArgumentException {
    assertEquals("None", Solution4Util.extractingContent("<h1>had<h1>public</h1515></h1>"));
  }

  @Test
  void input01Line4() throws IllegalArgumentException {
    assertEquals("None", Solution4Util.extractingContent("<h1><h1></h1></h1>"));
  }

  @Test
  void input01Line5() throws IllegalArgumentException {
    assertEquals("None", Solution4Util.extractingContent("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"));
  }
  ...
  void input01Line8() throws IllegalArgumentException {
    assertEquals("None", Solution4Util.extractingContent("<>hello</>"));
  }

  @Test
  void input01Line9() throws IllegalArgumentException {
    assertEquals("dim", Solution4Util.extractingContent("<>hello</><h>dim</h>"));
  }
  ...
  void input02Line1() throws IllegalArgumentException {
    assertEquals("bMUGux)5n7L={M}e^`0xlSm5ce}ehiE}CJ6y0KPd~~B~ak5$PTdPGv}QnXpw6n9V8wVCVaTRTgLKkeF", Solution4Util
